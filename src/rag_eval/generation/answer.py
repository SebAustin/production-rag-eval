...
_SYSTEM = (
    ...
    "passages. When a calculation is required, cite each source figure from the "
    "passages and give ONLY the final computed result; do not show intermediate "
    "arithmetic or restate computed sub-totals as separate sentences, and do not "
    "introduce numbers that are not in the passages. If the passages do not "
    "contain sufficient "
